!function e(t, n, i) {
    ...
    2: [function() {
        ...
        window.rgb2hsv = function() {
            var e, t, n, i, o, s = arguments[0] / 255, r = arguments[1] / 255, a = arguments[2] / 255, l = Math.max(s, r, a), d = l - Math.min(s, r, a), c = function(e) {
                return (l - e) / 6 / d + .5
            };
            return 0 == d ? i = o = 0 : (o = d / l,
            e = c(s),
            t = c(r),
            n = c(a),
            s === l ? i = n - t : r === l ? i = 1 / 3 + e - n : a === l && (i = 2 / 3 + t - e),
            0 > i ? i += 1 : i > 1 && (i -= 1)),
            {
                h: Math.round(360 * i),
                s: Math.round(100 * o),
        ...
        particlesMaskFn = function() {
            ...
            this.alignToMask = function(e) {
                for (var t = 0; t < e.count; t++)
                    this.setParticleToRandomUnmaskedPixel(e.plainArray[t]),
            ...
            this.setParticleToRandomUnmaskedPixel = function(e) {
                var t;
                do
                    t = Math.floor(Math.random() * mask.data.length);
                while (255 * Math.random() > mask.data[t]);var n = Math.floor(t / mask.w)
                  , i = t % mask.w;
    ...
    4: [function() {
        function e() {
            ...
            for (var t = ["sideColor", "seedColor"], n = new dat.GUI, i = 0, s = t[i]; i < t.length; i++,
            s = t[i])
                c.hsv[s] = rgb2hsv(c[s][0], c[s][1], c[s][2]),
                c.hsv[s].h /= 360,
                c.hsv[s].s /= 100,
                c.hsv[s].v /= 100,
        ...
        function n(e) {
            function t() {
                for (var e = 0; e < r.length; e++)
                    for (var t = 0; t < shell404.axises.length; t++)
                        s[r[e]][shell404.axises[t]] = shell404.dRange(o)
            }
            function n() {
                a.ang = 0,
        ...
        function s() {
            ...
            var o, s, a = 2, l = 2e3, d = [[material, 7 * a, [0, -l, 0], e]];
        ...
        var m = {
            ...
            init: function() {
                ...
                var t = 1e4;
                if (shell404.smallUnshiftedCube && (t = 100),
                shell404.skybox) {
                    var n = document.createElement("canvas");
                    n.width = 128,
                    n.height = 128;
        ...
        var _ = {
            ...
            init: function() {
                var e = (THREE.ImageUtils.loadTexture(l + "particle_tr.png"),
                THREE.ImageUtils.loadTexture(l + "disc.png"));
                if (_.plainArray = new Array(_.count),
                _.canvasMode)
                ...
                for (var s, r, d = 0; d < _.count; d++) {
                    if (r = new hotdot.particle(d),
                    _.plainArray[d] = r,
                    _.canvasMode)
                        s = new THREE.Particle(shell404.canvasSettings.particlesFromImage ? t : o(r)),
                ...
                _.canvasMode || (_.threeObject.sortParticles = !0,
                shell404.scene.add(_.threeObject))
            },
            explodeParameters: {
                max: {
                    pow: 10,
            ...
            update: function() {
                if (0 != _.plainArray.length) {
                    for (var e, t, n, i, o, s, r, a, l, d = _.count; d--; )
                        e = _.plainArray[d],
                        l = e.position,
                        a = e.velocity,
                        ...
                        u && (o = Math.atan2(l.z - u.z, l.x - u.x),
                        s = Math.sqrt(Math.pow(l.z - u.z, 2) + Math.pow(l.x - u.x, 2)),
                        s < _.explodeParameters.max.dist && (r = (_.explodeParameters.max.pow - _.explodeParameters.min.pow) * (1 - s / _.explodeParameters.max.dist) + _.explodeParameters.min.pow,
                        a.x = r * Math.cos(o),
                        a.z = r * Math.sin(o),
                        e.tween.setPaused(!0))),
                        i = e.color,
                        i.setRGB(_.mixRGB(0, t), _.mixRGB(1, t), _.mixRGB(2, t));
                    _.canvasMode || (_.threeObject.geometry.__dirtyVertices = !0,
                    _.threeObject.geometry.colorsNeedUpdate = !0)
                }
            }
        };
        window.updateObjects = function() {
            if (_.update(),
            shell404.linesConstructShouldRotate)
                for (var e = 0; e < shell404.scene.children.length; e++) {
                    var t = shell404.scene.children[e];
                    t instanceof THREE.Line && (t.rotation.x = shell404.time * (e % 2 ? 1 : -1) / 4,
                    t.rotation.y = shell404.time * (e % 2 ? 1 : -1) / 4)
                }
    ...
    5: [function() {
        ...
        window.shell404fn = function() {
            ...
            this.init = function() {
                ...
                e.applyCamAngles(),
                e.statsEnabled && (e.stats = new Stats,
                e.stats.domElement.style.position = "absolute",
                e.stats.domElement.style.top = "0px",
                e.stats.domElement.style.zIndex = 100,
                $("#container").append(e.stats.domElement)),
    ...
    6: [function() {
        window.Stats = function() {
            var e, t, n, i, o, s, r, a, l = 0, d = 0, c = Date.now(), u = c, h = c, p = 0, f = 1e3, m = 0, _ = [[16, 16, 48], [0, 255, 255]], g = 0, v = 1e3, b = 0, w = [[16, 48, 16], [0, 255, 0]];
            ...
            e.addEventListener("mousedown", function(e) {
                e.preventDefault(),
                l = (l + 1) % 2,
                0 == l ? (n.style.display = "block",
                s.style.display = "none") : (n.style.display = "none",
                s.style.display = "block")
            }, !1),
            n = document.createElement("div"),
            n.style.textAlign = "left",
            n.style.lineHeight = "1.2em",
            n.style.backgroundColor = "rgb(" + Math.floor(_[0][0] / 2) + "," + Math.floor(_[0][1] / 2) + "," + Math.floor(_[0][2] / 2) + ")",
            n.style.padding = "0 0 3px 3px",
            e.appendChild(n),
            i = document.createElement("div"),
            i.style.fontFamily = "Helvetica, Arial, sans-serif",
            i.style.fontSize = "9px",
            i.style.color = "rgb(" + _[1][0] + "," + _[1][1] + "," + _[1][2] + ")",
            ...
            o.style.width = "74px",
            o.style.height = "30px",
            o.style.backgroundColor = "rgb(" + _[1][0] + "," + _[1][1] + "," + _[1][2] + ")",
            n.appendChild(o); o.children.length < 74; )
            ...
            s.style.lineHeight = "1.2em",
            s.style.backgroundColor = "rgb(" + Math.floor(w[0][0] / 2) + "," + Math.floor(w[0][1] / 2) + "," + Math.floor(w[0][2] / 2) + ")",
            s.style.padding = "0 0 3px 3px",
            s.style.display = "none",
            e.appendChild(s),
            r = document.createElement("div"),
            r.style.fontFamily = "Helvetica, Arial, sans-serif",
            r.style.fontSize = "9px",
            r.style.color = "rgb(" + w[1][0] + "," + w[1][1] + "," + w[1][2] + ")",
            ...
            a.style.width = "74px",
            a.style.height = "30px",
            a.style.backgroundColor = "rgb(" + w[1][0] + "," + w[1][1] + "," + w[1][2] + ")",
            s.appendChild(a); a.children.length < 74; )
                t = document.createElement("span"),
                t.style.width = "1px",
            ...
            return {
                ...
                update: function() {
                    ...
                    u = c,
                    d++,
                    c > h + 1e3 && (p = Math.round(1e3 * d / (c - h)),
                    f = Math.min(f, p),
                    m = Math.max(m, p),
                    i.textContent = p + " FPS (" + f + "-" + m + ")",
                    e = Math.min(30, 30 - p / 100 * 30),
                    o.appendChild(o.firstChild).style.height = e + "px",
                    h = c,
                    d = 0)
                }
            }
        ...
        !function() {
            ...
            function() {
                ...
                e.removeTweens = function(t) {
                    if (t.tweenjs_count) {
                        for (var n = e._tweens, i = n.length - 1; i >= 0; i--)
                            n[i]._target == t && (n[i]._paused = !0,
                            n.splice(i, 1));
                        t.tweenjs_count = 0
                    }
                }
                ...
                e._register = function(t, n) {
                    var i = t._target;
                    n ? (i && (i.tweenjs_count = i.tweenjs_count ? i.tweenjs_count + 1 : 1),
                    e._tweens.push(t)) : (i && i.tweenjs_count--,
                    i = e._tweens.indexOf(t),
                    -1 != i && e._tweens.splice(i, 1))
                }
                ,
                ...
                t.setPosition = function(e, t) {
                    ...
                    return 0 != t && 0 < this._actions.length && (this._useTicks ? this._runActions(n, n) : 1 == t && o > n ? (o != this.duration && this._runActions(o, this.duration),
                    this._runActions(0, n, !0)) : this._runActions(o, n)),
                    i && this.setPaused(!0),
                ...
                t._updateTargetProps = function(t, i) {
                    var o, s, r, a;
                    t || 1 != i ? (t.e && (i = t.e(i, 0, 1, 1)),
                    o = t.p0,
                    s = t.p1) : o = s = this._curQueueProps;
                ...
                t._appendQueueProps = function(t) {
                    ...
                    for (a in t) {
                        ...
                        if (n = e._plugins[a])
                            ...
                            o = 0,
                            s = n.length; s > o; o++)
                                n[o].step && n[o].step(this, a, i, t[a], r);
            ...
            function() {
                ...
                t.removeTween = function(e) {
                    ...
                    if (t > 1) {
                        for (var n = !0, i = 0; t > i; i++)
                            n = n && this.removeTween(arguments[i]);
                        return n
                    }
                    return 0 == t ? !1 : (t = this._tweens.indexOf(e),
                    -1 != t ? (this._tweens.splice(t, 1),
                ...
                t.setPosition = function(e, t) {
                    ...
                    for (var o = 0, s = this._tweens.length; s > o; o++)
                        if (this._tweens[o].setPosition(n, t),
                        n != this._prevPos)
                            return !1;
            ...
            function() {
                ...
                e.step = function(t, n, i, o, s) {
                    ...
                    o.hasOwnProperty("start") || (o.start = i && i.hasOwnProperty("end") && i.path === t ? i.end : 0),
                ...
                e.tween = function(t, n, i, o, s, r, a) {
                    return s = s.guide,
                    void 0 == s || s === o.guide ? i : (s.lastRatio != r && (e.calc(s, (s.end - s.start) * (a ? s.end : r) + s.start, t.target),
                    s.orient && (t.target.rotation += o.rotation || 0),
                    s.lastRatio = r),
                    s.orient || "rotation" != n ? t.target[n] : i)
                }
                ,
                e.calc = function(t, n, i) {
                    ...
                    for (n = 0; r > o[n] && a > n; )
                        r -= o[n],
                        n += 2;
                    for (var o = o[n + 1], l = 0, a = o.length - 1; r > o[l] && a > l; )
                        r -= o[l],
                        l++;
                ...
                each: function(t, n, i) {
                    if (e && t.forEach === e)
                        ...
                        for (var o = 0, s = t.length; s > o; o++)
                            if (o in t && n.call(i, t[o], o) === this.BREAK)
                                return
                    } else
                        for (var o in t)
                            if (n.call(i, t[o], o) === this.BREAK)
                                return
                },
                defer: function(e) {
                    setTimeout(e, 0)
        ...
        dat.GUI = dat.gui.GUI = function(e, t, n, i, o, s, r, a, l, d, c, u, h, p, f) {
            ...
            function g(e, t, n) {
                ...
                f.extend(n, {
                    options: function(t) {
                        ...
                        })) : f.isArray(t) || f.isObject(t) ? (n.remove(),
                        m(e, n.object, n.property, {
                            before: n.__li.nextElementSibling,
                            factoryArgs: [t]
                        })) : void 0
                ...
                n instanceof l) {
                    ...
                    n.updateDisplay = f.compose(function(e) {
            ...
            function v(e, t) {
                ...
                if (-1 != i) {
                    ...
                    if (void 0 === o && (o = {},
                    n.__rememberedObjectIndecesToControllers[i] = o),
                    o[t.property] = t,
            ...
            e.inject(n);
            var P, R, M = "dg", S = 72, O = 20, H = "Default", I = function() {
                try {
                    return "localStorage"in window && null !== window.localStorage
                } catch (e) {
                    return !1
                }
            }(), L = !0, j = !1, z = [], N = function(e) {
                function t() {
                ...
                if (Object.defineProperties(this, {
                    ...
                    useLocalStorage: {
                        ...
                        set: function(e) {
                            I && (o = e,
                            e ? p.bind(window, "unload", t) : p.unbind(window, "unload", t),
                            localStorage.setItem(b(i, "isLocal"), e))
                        }
                    }
                }),
                ...
                e.autoPlace && (f.isUndefined(e.parent) && (L && (R = document.createElement("div"),
                p.addClass(R, M),
                p.addClass(R, N.CLASS_AUTO_PLACE_CONTAINER),
            ...
            f.extend(N.prototype, {
                ...
                onResize: function() {
                    ...
                    if (e.scrollable) {
                        ...
                        window.innerHeight - t - O < n ? (p.addClass(e.domElement, N.CLASS_TOO_TALL),
                        e.__ul.style.height = window.innerHeight - t - O + "px") : (p.removeClass(e.domElement, N.CLASS_TOO_TALL),
                ...
                remember: function() {
                    if (f.isUndefined(P) && (P = new h,
                    P.domElement.innerHTML = t),
                    this.parent)
                ...
                getSaveObject: function() {
                    ...
                    e.folders = {},
                    f.each(this.__folders, function(t, n) {
            ...
            function o(e, t, n) {
                Object.defineProperty(e, t, {
                    get: function() {
                        return "RGB" === this.__state.space ? this.__state[t] : (r(this, t, n),
                        this.__state[t])
                    },
                    set: function(e) {
                        "RGB" !== this.__state.space && (r(this, t, n),
            ...
            return {
                ...
                rgb_to_hsv: function(e, t, n) {
                    var i, o, s = Math.min(e, t, n), r = Math.max(e, t, n), a = r - s;
                    return 0 == r ? {
                        h: 0 / 0,
                        s: 0,
                        v: 0
                    } : (o = a / r,
                    i = e == r ? (t - n) / a : t == r ? 2 + (n - e) / a : 4 + (e - t) / a,
                    i /= 6,
                    0 > i && (i += 1),
                    {
                        h: 360 * i,
    ...
    9: [function() {
        !function() {
            shell404.canvasMode && !Modernizr.canvas || !shell404.canvasMode && !Modernizr.webgl || ($("#container .fallback").hide(),
            shell404.init(),
            shell404.update())
        }()
    }
